...
- Introduction: the `setup.cake` script that guess the version and gather all
  the requirements.

- Body: the `build.cake` and `test.cake` scripts that converts and validates the
  developer codes against a compiler and quality assurance tests.
